...
public class Four_mode_offers {

	private static Four_mode_offers tmo=null;
    private JFrame frame;
	private JLabel lblCard1_1;
	private JLabel lblCard2_1;
	private JLabel lblCard3_1;
	private JLabel lblCard4_1;
	...
	private JLabel lblCardDown4_2;
	private LinkedList<Card> offers;
	private Player player_return;
	private Player player_next;
	private Card add_to_drawdeck;
    public  static int rest_num=4; //还剩下的人数，根据这个调用不同的函数，还可以标识回合结束
	/**
	 * Launch the application.
	 */
	
	public static Four_mode_offers getinstance() {
		if(tmo==null) {
			tmo=new Four_mode_offers();
		}
		return tmo;
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Four_mode_offers window = new Four_mode_offers();
	...
	private void initialize() {
		...
		comboBox_player.addItem(Four_p_s_next.player1_name);
		comboBox_player.addItem(Four_p_s_next.player2_name);
		comboBox_player.addItem(Four_p_s_next.player3_name);
		comboBox_player.addItem(Four_p_s_next.player4_name);
		...
		btnNext.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				/////////////////////////////////1/4 15:14
					...
					You_have_chosen_4version yhc=new You_have_chosen_4version();
		...
		JLabel lblPlayer_1 = new JLabel(Four_p_s_next.player1_name);
		lblPlayer_1.setBounds(63, 33, 87, 13);
		frame.getContentPane().add(lblPlayer_1);
		
		JLabel lblPlayer_2 = new JLabel(Four_p_s_next.player2_name);
		lblPlayer_2.setBounds(210, 33, 69, 13);
		frame.getContentPane().add(lblPlayer_2);
		
		JLabel lblPlayer_3 = new JLabel(Four_p_s_next.player3_name);
		lblPlayer_3.setBounds(363, 33, 70, 13);
		...
		JLabel lblPlayer_4 = new JLabel(Four_p_s_next.player4_name);
		lblPlayer_4.setBounds(519, 33, 70, 13);
	...
	public void add_card(Player p,Card c1) {//c1 is the card faceON 
		...
		if(p.get_nom().equals(Four_p_s_next.player1_name)) {
			this.lblCard1_1.setIcon(img);
		}else if(p.get_nom().equals(Four_p_s_next.player2_name)) {
			this.lblCard2_1.setIcon(img);
		}else if(p.get_nom().equals(Four_p_s_next.player3_name)) {
			this.lblCard3_1.setIcon(img);
		}
		else if(p.get_nom().equals(Four_p_s_next.player4_name)) {
			this.lblCard4_1.setIcon(img);
		}
	...
	public void set_not_afficher_card(Player p) {
		...
		if(p.get_nom().equals(Four_p_s_next.player1_name)) {
			...
			this.lblCardDown4_2.setVisible(false);
			this.lblCard4_1.setVisible(false);
		}
	}
	public void set_all_afficher() {
		...
		this.lblCard4_1.setVisible(true);
		this.lblCardDown4_2.setVisible(true);
	}
