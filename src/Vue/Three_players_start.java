...
public class Three_players_start extends JFrame {
    private Three_players_start three_players_start;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Three_players_start frame = new Three_players_start();
	...
	public Three_players_start() {
		...
		new Three_p_s_next(this,comboBox, comboBox_1,btnNext,textField,textField_1,textField_2);
