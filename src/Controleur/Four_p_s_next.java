...
public class Four_p_s_next {
	
private static Four_p_s_next fps=null;
	...
	private static int num_p=4;
	private static int num_real;
	private static int level_com;
	
	private GM gm;
	
	public static Four_p_s_next getinstance() {
		if(fps == null) {
			fps=new Four_p_s_next();
		}
		return fps;
	}
	...
	public Four_p_s_next(JFrame frame,JComboBox comboBox,JComboBox comboBox_1,JButton btnNext,JTextField textField,JTextField textField_1,JTextField textField_2,JTextField textField_3) {
		btnNext.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(num_real==1) {					
						...
						player4_name="Computer3";
				}else if(num_real==2) {  
					    player2_name=textField.getText();
						player3_name="Computer1";
						player4_name="Computer2";
				}else if(num_real==3){
						player2_name=textField.getText();
						player3_name=textField_2.getText();
						player4_name="Computer1";
				}else {
						player2_name=textField.getText();
						player3_name=textField_2.getText();
						player4_name=textField_3.getText();
				}
				...
				//need to change
				Four_mode_playingScene four_mode_ps=Four_mode_playingScene.getinstance();
				if(num_real==0 || com_level==0 || textField_1.getText().trim().equals("")) {
					...
					frame.dispose();
				    four_mode_ps.setVisible(true);
				}
			}
		});
	}
	
	public Four_p_s_next() {
